...
def gen_frozen_graph(ckpt_dir,var_ckpt):
    freeze_graph.freeze_graph(os.path.join(ckpt_dir, input_path),
                              input_saver,
                              input_binary,
                              os.path.join(ckpt_dir, var_ckpt),
                              output_node_names,
                              restore_op_name,
    ...
    os.remove(os.path.join(ckpt_dir, input_path))
